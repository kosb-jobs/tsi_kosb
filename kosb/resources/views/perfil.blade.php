                ...
                <div class="row">
                    <div class="col-md-3 mb-5">
                        <div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical">
                            ...
                            <a class="nav-link" href="{{route('buscar_trabajo')}}" role="tab"><ion-icon name="search-outline"></ion-icon>Busqueda de Publicaciones</a>
                            ...
                            <a class="nav-link" id="account-nav" data-toggle="pill" href="#account-tab" role="tab"><ion-icon name="bar-chart"></ion-icon>Detalles De Cuenta</a>
